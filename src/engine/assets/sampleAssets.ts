    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { id: 'assets/scripts/ui-button-click.js', name: 'ui-button-click.js', type: 'script', path: 'assets/scripts/ui-button-click.js' },
          { id: 'assets/scripts/pause-menu.js', name: 'pause-menu.js', type: 'script', path: 'assets/scripts/pause-menu.js' },
          { id: 'assets/scripts/pause-menu-action.js', name: 'pause-menu-action.js', type: 'script', path: 'assets/scripts/pause-menu-action.js' },
